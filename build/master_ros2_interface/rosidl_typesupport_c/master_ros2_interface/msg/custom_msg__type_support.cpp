...
static const _CustomMsg_type_support_symbol_names_t _CustomMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, master_ros2_interface, msg, CustomMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, master_ros2_interface, msg, CustomMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, master_ros2_interface, msg, CustomMsg)() {
  return &::master_ros2_interface::msg::rosidl_typesupport_c::CustomMsg_message_type_support_handle;
}
