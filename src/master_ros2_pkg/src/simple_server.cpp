...
public:
    StringConcatService() : Node("string_concat_services")
    {
        RCLCPP_INFO(this->get_logger(), "Started ROS 2 Service Server");

        service_ = this->create_service<master_ros2_interface::srv::ConcatStrings>("concat_strings",
                                                                                   std::bind(&StringConcatService::handle_service,
                                                                                             this,
