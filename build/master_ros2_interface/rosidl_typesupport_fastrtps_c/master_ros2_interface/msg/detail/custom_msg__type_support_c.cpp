...
#include "master_ros2_interface/msg/detail/custom_msg__rosidl_typesupport_fastrtps_c.h"
...
using _CustomMsg__ros_msg_type = master_ros2_interface__msg__CustomMsg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = master_ros2_interface__msg__CustomMsg;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const master_ros2_interface__msg__CustomMsg * ros_message = static_cast<const master_ros2_interface__msg__CustomMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_master_ros2_interface__msg__CustomMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  master_ros2_interface__msg__CustomMsg * ros_message = static_cast<master_ros2_interface__msg__CustomMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_master_ros2_interface__msg__CustomMsg(cdr, ros_message);
}

static uint32_t _CustomMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_master_ros2_interface__msg__CustomMsg(
...
static size_t _CustomMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_master_ros2_interface__msg__CustomMsg(
